...
function getConvertOptions(output) {
    ...
    return Promise().then(function () {
        ...
        return Promise.all([getPDFTemplate(output, 'header'), getPDFTemplate(output, 'footer')]).spread(function (headerTpl, footerTpl) {
...
//# sourceMappingURL=getConvertOptions.js.map